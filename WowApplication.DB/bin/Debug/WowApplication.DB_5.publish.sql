...
GO
/*
La colonne [dbo].[Item].[IdEncounter] est en cours de suppression, des données risquent d'être perdues.
*/
...
GO
PRINT N'Suppression de [dbo].[FK_Item_Encounter]...';


GO
ALTER TABLE [dbo].[Item] DROP CONSTRAINT [FK_Item_Encounter];


GO
PRINT N'Modification de [dbo].[Item]...';


GO
ALTER TABLE [dbo].[Item] DROP COLUMN [IdEncounter];
