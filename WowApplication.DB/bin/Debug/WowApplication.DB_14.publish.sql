...
GO
PRINT N'Création de [dbo].[PK_EncounterItem]...';


GO
ALTER TABLE [dbo].[EncounterItem]
    ADD CONSTRAINT [PK_EncounterItem] PRIMARY KEY CLUSTERED ([IdItem] ASC, [IdEncounter] ASC);
...
GO
ALTER TABLE [dbo].[EncounterItem] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[EncounterItem] WITH CHECK CHECK CONSTRAINT [FK_Encounter_Item];

ALTER TABLE [dbo].[EncounterItem] WITH CHECK CHECK CONSTRAINT [FK_Item_Encounter];
